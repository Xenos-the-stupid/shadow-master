  ...
  return (
    <div className={cn("relative", props.outerDivClasses)}>
      <input
        ...
        className={cn(
          "rounded-sm border border-border-color-dark px-1 outline-offset-4 focus:border-border-color focus:outline-1 dark:border-border-color-dark dark:bg-black",
          props.className,
        )}
      />
      {props.type === "number" ? (
